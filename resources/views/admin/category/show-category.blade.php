                ...
                <tr id="category-row-{{ $value->id }}">
                    ...
                    <td>
                        <button type="button" class="toggle-status btn {{ $value->status == 1 ? 'active' : '' }}"
                            ...
                            data-inactive-url="{{ URL::to('category/unactive/' . $value->id) }}" data-toggle="tooltip"
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="categoryForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" class="form-control" name="categoryName" required
                                data-slug-source="category">
                        </div>
                        <div class="form-group">
                            <label>Slug<small class="note">(tự động)</small></label>
                            <input type="text" name="categorySlug" id="inputSlug" class="form-control" required
                                data-slug-target="category">
                        </div>
                        <div class="form-group">
