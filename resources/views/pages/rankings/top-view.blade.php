...
<div class="rank-container">
    @foreach ($top_view as $value)
        @if ($value->views_sum_view_count > 0)
            <a href="{{ URL::to('phim/' . $value->slug) }}" class="text-white">
                <div class="row rank-item">
                    <div class="col-3 col-lg-3 col-md-5">
                        <img class="img-fluid" src="{{ asset('uploads/movies/' . $value->image) }}"
                    ...
                    <div class="col-9 col-lg-8 col-md-7">
                        ...
                        <span class="view">
                            ...
                            {{ number_format($value->views_sum_view_count) }} lượt xem
                        </span>
                    </div>
                </div>
            </a>
